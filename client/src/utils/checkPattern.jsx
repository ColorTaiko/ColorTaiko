...
/**
 * Call this whenever a horizontal edge between nodeA & nodeB is added or its color / orientation changes.
 * It"ll extract all new horizontal trios involving this edge & update trioMap.
 ...
 * @param {string} nodeA  1st node of the changed edge (e.g., "top-1").
 * @param {string} nodeB  2nd node of the changed edge (same row: both top or both bottom).
 */
